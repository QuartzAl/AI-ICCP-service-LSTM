...
def build_tunable_model(hp):
    ...
    hp_units_1 = hp.Int('lstm_units_1', min_value=64, max_value=512, step=32)
...
def main():
    ...
    tuner = kt.BayesianOptimization(
        build_tunable_model,
        objective='val_loss',
        max_trials=50,                      # Total model configurations to test
